...
import { getMobilityProviderById } from 'apiSdk/mobility-providers';
...
function MobilityProviderViewPage() {
          ...
          <>
            ...
            {hasAccess('transaction', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
              <>
                ...
                <NextLink passHref href={`/transactions/create?mobility_provider_id=${data?.id}`}>
